...
export class OrganisationUpdateComponent implements OnInit {
  ...
  protected updateForm(organisation: IOrganisation): void {
    ...
    this.villesSharedCollection = this.villeService.addVilleToCollectionIfMissing<IVille>(this.villesSharedCollection, organisation.ville);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.villeService
      ...
      .pipe(map((villes: IVille[]) => this.villeService.addVilleToCollectionIfMissing<IVille>(villes, this.organisation?.ville)))
