...
import { sampleWithRequiredData } from '../opportunite.test-samples';
import { OpportuniteService } from '../service/opportunite.service';

import { OpportuniteComponent } from './opportunite.component';
import SpyInstance = jest.SpyInstance;

describe('Opportunite Management Component', () => {
  let comp: OpportuniteComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(OpportuniteComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.opportunites()[0]).toEqual(expect.objectContaining({ id: 2855 }));
  });

  describe('trackId', () => {
    it('should forward to opportuniteService', () => {
      const entity = { id: 2855 };
      jest.spyOn(service, 'getOpportuniteIdentifier');
      const id = comp.trackId(entity);
      expect(service.getOpportuniteIdentifier).toHaveBeenCalledWith(entity);
