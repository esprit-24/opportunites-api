...
import { CandidatService, EntityArrayResponseType } from '../service/candidat.service';
...
export class CandidatComponent implements OnInit {
  ...
  protected readonly candidatService = inject(CandidatService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: ICandidat): number => this.candidatService.getCandidatIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.candidats.set(dataFromBody);
  }
