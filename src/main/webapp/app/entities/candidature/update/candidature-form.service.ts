...
type CandidatureFormGroupContent = {
  ...
  statutCandidature: FormControl<CandidatureFormRawValue['statutCandidature']>;
  lettreMotivation: FormControl<CandidatureFormRawValue['lettreMotivation']>;
  opportunite: FormControl<CandidatureFormRawValue['opportunite']>;
...
export class CandidatureFormService {
  createCandidatureFormGroup(candidature: CandidatureFormGroupInput = { id: null }): CandidatureFormGroup {
    ...
    return new FormGroup<CandidatureFormGroupContent>({
      ...
      statutCandidature: new FormControl(candidatureRawValue.statutCandidature),
      lettreMotivation: new FormControl(candidatureRawValue.lettreMotivation),
      opportunite: new FormControl(candidatureRawValue.opportunite),
