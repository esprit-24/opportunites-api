...
public class CandidatureAsserts {
    ...
    public static void assertCandidatureUpdatableFieldsEquals(Candidature expected, Candidature actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getStatutCandidature()).as("check statutCandidature").isEqualTo(expected.getStatutCandidature()))
            .satisfies(a -> assertThat(a.getLettreMotivation()).as("check lettreMotivation").isEqualTo(expected.getLettreMotivation()));
    }
    ...
    public static void assertCandidatureUpdatableRelationshipsEquals(Candidature expected, Candidature actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getOpportunite()).as("check opportunite").isEqualTo(expected.getOpportunite()))
